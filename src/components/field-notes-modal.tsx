...
function FieldNotesPanel({
  ...
  return (
    <>
      ...
      />
      {/* Panel */}
      <div className="fixed left-1/2 top-16 z-[60] flex w-[min(360px,calc(100vw-2rem))] max-h-[min(72vh,540px)] -translate-x-1/2 flex-col rounded-[20px] border border-zinc-200 bg-white/98 p-4 shadow-2xl sm:left-auto sm:top-14 sm:right-4 sm:translate-x-0">
